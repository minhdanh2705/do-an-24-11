            ...
            {studentsAtStop.map(hs => (
                <ListItem 
                    ...
                    secondaryAction={
                        isCompleted ? (
                            <Chip 
                                // --- ĐÃ SỬA: Chấp nhận cả trạng thái 1 (Lên xe) và 2 (Đã trả) ---
                                label={(hs.trangThai === 1 || hs.trangThai === 2) ? "Đã hoàn thành" : "Vắng"} 
                                color={(hs.trangThai === 1 || hs.trangThai === 2) ? "success" : "error"} 
                                size="small" 
                                variant="outlined"
                                sx={{ 
                                    borderColor: (hs.trangThai === 1 || hs.trangThai === 2) ? '#66bb6a' : '#ef5350', 
                                    color: (hs.trangThai === 1 || hs.trangThai === 2) ? '#66bb6a' : '#ef5350' 
                                }}
                            />
                        ) : (
                            isStarted && (
